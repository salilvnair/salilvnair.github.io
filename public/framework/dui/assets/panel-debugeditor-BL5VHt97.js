import{r,j as e,cJ as s}from"./dui-lib-BnlA1uqk.js";import{R as y,E as c,D as a,a as h,F as w,P as k}from"./panel-chipsview-DlzNYVNl.js";function E(){const[d,v]=r.useState(`// Pre-request script
...
/>`,children:e.jsxs("div",{style:{width:"100%"},children:[e.jsx(s,{value:d,onChange:v,language:"javascript",height:"200px",breakpoints:u,pausedLine:l,adapter:{onToggleBreakpoint:i=>g(n=>n.includes(i)?n.filter(x=>x!==i):[...n,i])}}),e.jsxs("div",{style:{marginTop:6,fontSize:11,color:"var(--color-text-muted)"},children:["Click gutter to toggle breakpoints · Yellow = paused line · Active: ",u.join(", ")||"none"]})]})})})}const _=Object.freeze(Object.defineProperty({__proto__:null,DebugEditorViewLive:E},Symbol.toStringTag,{value:"Module"})),b=`async function fetchUser(userId) {
...
def load_dashboard():
    ...
    return user`;function D(){const[d,v]=r.useState([3,7]),[u,g]=r.useState([3,7]),[l,i]=r.useState(5),[n,x]=r.useState(null),f={onToggleBreakpoint:o=>{v(t=>t.includes(o)?t.filter(p=>p!==o):[...t,o])}},j={onToggleBreakpoint:o=>{g(t=>t.includes(o)?t.filter(p=>p!==o):[...t,o])}},m={onToggleBreakpoint:o=>{g(t=>t.includes(o)?t.filter(p=>p!==o):[...t,o])},onEditorMount:(o,t)=>{x("Editor mounted — hover adapter ready")}};return e.jsxs("div",{children:[e.jsxs(c,{title:"JavaScript with Breakpoints (lines 3 and 7)",description:"Click in the gutter to toggle breakpoints — red dots appear on active breakpoint lines",code:`const [breakpoints, setBreakpoints] = useState([3, 7]);
...
<DebugEditorView value={snippet} language="javascript" adapter={adapter} />`,children:[e.jsx("div",{style:{height:240,border:"1px solid var(--color-surface-border)",borderRadius:6,overflow:"hidden"},children:e.jsx(s,{value:b,language:"javascript",breakpoints:[3],pausedLine:3,adapter:m,editorOptions:{minimap:!1}})}),n&&e.jsx("div",{style:{marginTop:6,fontSize:11,color:"var(--color-success)",fontFamily:"monospace"},children:n})]}),e.jsxs(c,{title:"Read-Only Debug Viewer",description:"readOnly=true — shows breakpoints and paused line for inspection without editing",code:`<DebugEditorView
  value={jsSnippet}
  language="javascript"
  breakpoints={[3, 7]}
  pausedLine={7}
