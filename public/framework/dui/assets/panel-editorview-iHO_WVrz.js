import{r as d,j as e,aF as o,aG as L,aH as O,aI as I,aJ as k,aK as j,n as A,k as N,v as z,av as M,at as D,g as W}from"./dui-lib-CMA--A_A.js";import{E as l,D as c,F as y,a as v,I as u,P as b,b as i,S as T}from"./panel-badgechip-DpEaHX-u.js";const P=`{
  "userId": 42,
...
const result = await fetch("https://api.example.com/users?limit=100&offset=0&sort=createdAt&order=desc&filter=active", { method: "GET", headers: { "Authorization": "Bearer token123" } });`,F=`async function fetchUsers(token) {
