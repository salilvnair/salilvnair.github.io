import{r,j as e,h as i,bh as o}from"./dui-lib-D_5u_TrP.js";import{E as n,D as l,F as b,P as C,b as c}from"./panel-badgechip-qgj4nFkf.js";function m(){const a=r.useRef(null),u=r.useRef(null),f=r.useRef(null),d=r.useRef(null),p=r.useRef(null);return e.jsxs("div",{children:[e.jsxs(n,{title:"Basic Fire",description:"Fire a burst from a button click — origin defaults to viewport center",code:`function Preview() {
