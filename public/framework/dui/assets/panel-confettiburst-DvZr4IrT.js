import{r,j as e,B as i,be as o}from"./dui-lib-BnlA1uqk.js";import{E as n,D as l,F as m,P as C,a as c}from"./panel-chipsview-DlzNYVNl.js";function b(){const a=r.useRef(null),u=r.useRef(null),f=r.useRef(null),d=r.useRef(null),p=r.useRef(null);return e.jsxs("div",{children:[e.jsxs(n,{title:"Basic Fire",description:"Fire a burst from a button click — origin defaults to viewport center",code:`function Preview() {
