import{r as o,j as e,aS as a,G as b,L as g,m as n}from"./dui-lib-BoPcLOzx.js";import{E as i,D as t,F as s,P as f,c as C,a as r,S as y,b as S}from"./panel-chipsview-DUXBy88l.js";function j(){const[c,d]=o.useState("pro"),[l,p]=o.useState("bearer"),[u,h]=o.useState("us-east"),[v,m]=o.useState("team"),[x]=o.useState("archived");return e.jsxs("div",{children:[e.jsx(i,{title:"Default Single-Column List",description:"Stacked radio cards for a simple environment picker",code:`const [env, setEnv] = useState('staging');
