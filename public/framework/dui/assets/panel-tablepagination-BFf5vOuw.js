import{r as o,j as e,bQ as a}from"./dui-lib-BoPcLOzx.js";import{E as t,D as r,F as l,P as b,a as s,S as y}from"./panel-chipsview-DUXBy88l.js";function R(){const[p,c]=o.useState(1),[P,d]=o.useState(10),[n,i]=o.useState(1),[g,h]=o.useState(25),[u,w]=o.useState(1),[x,m]=o.useState(3);return e.jsxs("div",{children:[e.jsx(t,{title:"Default Pagination",description:"Standard footer with rows-per-page selector and page range",code:`const [page, setPage] = useState(1);
