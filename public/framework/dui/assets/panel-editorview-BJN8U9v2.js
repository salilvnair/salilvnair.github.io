import{r as d,j as e,O as o,Q as L,U as O,V as I,X as k,Y as j,t as A,u as N,I as z,W as M,q as W,k as D}from"./dui-lib-D_5u_TrP.js";import{E as l,D as c,F as y,b as v,I as u,P as b,a as i,S as T}from"./panel-badgechip-qgj4nFkf.js";const P=`{
  "userId": 42,
...
}`,U=`// Word wrap demo: long lines that would normally require horizontal scrolling are wrapped to the next line, improving readability.
const result = await fetch("https://api.example.com/users?limit=100&offset=0&sort=createdAt&order=desc&filter=active", { method: "GET", headers: { "Authorization": "Bearer token123" } });`,_=`async function fetchUsers(token) {
...
/>`,noPad:!0,children:e.jsx(o,{value:V,language:"json",height:"160px",readOnly:!0,editorOptions:h})}),e.jsx(l,{title:"Word Wrap On",description:"wordWrap=true prevents horizontal scrolling for long single-line content",code:`<EditorView
  ...
  height="100px"
  wordWrap
/>`,noPad:!0,children:e.jsx(o,{value:U,language:"javascript",height:"100px",wordWrap:!0})}),e.jsx(l,{title:"Custom fontSize and Height",description:"fontSize overrides the DUI size token — use for dense logs or large editors",code:`// Dense log viewer
