import{r as n,j as e,cy as a,h}from"./dui-lib-D_5u_TrP.js";import{E as s,D as d,F as j,P as C,b as c}from"./panel-badgechip-qgj4nFkf.js";function o({name:l,value:i}){return e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"4px 12px",fontSize:12},children:[e.jsx("span",{style:{color:"var(--color-text-secondary)",fontFamily:"monospace"},children:l}),e.jsx("span",{style:{color:"var(--color-success)",fontFamily:"monospace"},children:i})]})}function p({fn:l,file:i,line:r}){return e.jsxs("div",{style:{padding:"3px 12px",fontSize:12},children:[e.jsx("span",{style:{color:"var(--color-text-primary)",fontFamily:"monospace"},children:l}),e.jsxs("span",{style:{color:"var(--color-text-muted)",marginLeft:8},children:[i,":",r]})]})}function w(){const[l,i]=n.useState(!0),[r,x]=n.useState(!1),[u,g]=n.useState(!0),[b,m]=n.useState(!0),[v,f]=n.useState(!0),[S,y]=n.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{title:"Variables Section — Expanded with Badge",description:"Shows 3 local variables; badge=3 signals how many vars are in scope",code:`<CollapsibleSectionView
  title="Variables"
  expanded={open}
